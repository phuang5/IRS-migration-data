...
To deal with this issue, the updated version change the way combined FIPS codes are generated in the *Create Variables* section of *002-flatten_data.R*. Rather than combining character variables, I treat them as numeric variables combined by $1000\times FIPS\_state+FIPS\_county$. 
...
To explained what happened turns out to be non-trivial, so readers can ignore this section if they get bored. 
